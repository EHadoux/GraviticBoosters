...
As a side note, this API has been used for 5 years in several StarCraft AI Competitions, like\,\footnote{\url{http://webdocs.cs.ualberta.ca/~cdavid/starCraftaicomp/}}. % TODO Revoir cette phrase (cf review 3)
